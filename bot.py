...
async def send_test_closing():
    ...
    send_via_my_bot(me.id, message)
    print(f"🧪 Teste temporário das 23:50 enviado: {message}")
...
async def main():
    ...
    # TESTE TEMPORÁRIO ÀS 23:50: remover depois de validar a mensagem das 23:59.
    scheduler.add_job(send_test_closing, "cron", hour=23, minute=50)
